        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col justify-evenly animate-slide-down">
            ...
            <div className="mt-4 sm:mt-2 mr-5 sm:mr-28">
              ...
              <h3 className="text-xl font-normal">
                {' '}
                Award-winning poet Stella Ornelas is dropping by on March 10, 7
                PM. She will be reading from her new collection, Spring, and
          ...
          <div className="hidden md:grid grid-cols-6 gap-1 shadow-lg animate-slide-down">

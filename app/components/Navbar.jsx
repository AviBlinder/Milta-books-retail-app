    ...
    >
      ...
      >
        ...
        <div className="flex lg:hidden">
          <button
            type="button"
            className="ml-2 mr-2 inline-flex items-center justify-center p-2.5 text-gray-400
            bg-bridal-900 rounded-full"
      ...
      >
        ...
        px-4 sm:max-w-sm sm:ring-1 sm:ring-white/10"
        >
          <div className="flex items-center justify-between ">
            ...
            <button
              type="button"
              className="-m-2 rounded-md p-4 text-gray-600"
